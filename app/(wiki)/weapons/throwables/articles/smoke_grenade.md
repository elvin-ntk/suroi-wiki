...
- The Smoke Grenade can be used as a way to quickly get a temporary place to hide.
  ...
  - You can also use it in offense as a way to hide yourself while attacking, making it harder for enemies to find your exact location.
  - However, while inside smoke, your scope is reduced to 1x, which can make it hard to see your enemies. 
